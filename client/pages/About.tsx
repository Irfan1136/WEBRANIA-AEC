...
export default function About() {
  const focusAreas = [
    ...
    },
    {
      ...
      description:
        "Creating lasting bonds and networks that benefit the entire CSE community",
    },
  ];
            ...
            <Card className="tech-border tech-glow max-w-5xl mx-auto">
              <CardContent className="p-12">
                <p className="text-xl leading-relaxed text-muted-foreground text-center italic">
                  <strong className="tech-gradient-text">
                    WEBRANIA – The CSE Department Association
                  </strong>
                  , is formed by students, for students. We aim to create a
                  platform where every member can learn, innovate, and grow
                  together. From technical events to cultural programs, from
                  academic support to problem- solving with management, WEBRANIA
                  ensures that every student feels connected, supported, and
                  inspired.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="tech-border tech-glow max-w-4xl mx-auto">
              <CardContent className="p-12 text-center">
                <div className="space-y-6">
                  ...
                  <h3 className="text-2xl font-bold tech-gradient-text">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    education, preparing students for the challenges of
